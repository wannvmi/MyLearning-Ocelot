...
namespace Demo.IdentityServer
{
    public class UserStore
    {
        ...
        public UserStore(DemoDbContext context)
        {
            _context = context;
        }
        ...
        /// <returns></returns>
        public User FindBySubjectId(string id)
        {
        ...
        {
            return _context.User.FirstOrDefault(x => x.Username.Equals(username, StringComparison.OrdinalIgnoreCase));
        }
        ...
        {
            return _context.User.FirstOrDefault(x =>
